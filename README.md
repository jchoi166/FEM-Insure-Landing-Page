...
Card View had to be modifed so that the file path for images in production copy started with "./images". 

When making edits in development, add a "." in the image src in card view to see logos. 